...
app.post('/transfer', (req,res) =>{
  ...
  const accontsJson = JSON.stringify(accounts);

  fs.writeFileSync(path.join(__dirname,'json','accounts.json'),accontsJson,'utf8');
...
app.post('/payment', (req,res) =>{
  ...
  fs.writeFileSync(path.join(__dirname,'json','payment.json','utf8'));
